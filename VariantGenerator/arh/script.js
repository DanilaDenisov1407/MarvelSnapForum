document.addEventListener('DOMContentLoaded', () => {
  ...
  function clearInput(input) {
    ...
    if (input === rarityInput && rarityStyleSelect) {
      ...
      if (scaledRarityText) safeSetText(scaledRarityText.querySelector('span'), rarityStyles[style]);
    }
  }
  ...
  if (resetButton) {
    resetButton.addEventListener('click', () => {
      ...
      if (rarityStyleSelect) rarityStyleSelect.value = 'webshop-reward';
      if (rarityText && rarityText.querySelector('span')) safeSetText(rarityText.querySelector('span'), rarityStyles['webshop-reward']);
